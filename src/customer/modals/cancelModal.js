...
import { cancelOrderAsync } from "../orders/orderSlice";
import { useNavigate } from "react-router";
import { addMoneyAsync } from "../auth/userSlice";
import { toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";

const CancelModa̵l = ({ isOpen, onClose, id, discount }) => {
  ...
  const handleSubmit = () => {
    if (selectedProduct && returnReason) {
      onClose();
      dispatch(cancelOrderAsync({ orderId: id, productId: selectedProduct }));
      ...
      const data = {
        ...
        history: {
          ...
          message: "Refund on Cancel Product",
          date: currentDate,
